        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="insert_livro.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="exemplares" name="exemplares" value="<?php echo $linha['exemplares']; ?>" class="form-control">
                            </div>
                        </div>
